...
namespace Tum4ik.JustClipboardManager.Migrations
{
    ...
    [Migration("20230906213344_AddedRepresentationDataDotnetType")]
    partial class AddedRepresentationDataDotnetType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tum4ik.JustClipboardManager.Data.Models.Clip", b =>
                {
                    ...
                    b.Property<string>("RepresentationDataDotnetType")
                        .IsRequired()
                        .HasColumnType("TEXT");
